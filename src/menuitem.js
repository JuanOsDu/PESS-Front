...
//         <MenuItem onClick={handleClose}>Consultar Empleado</MenuItem>
//         </Link>
//         <Link to= "/components/agregarempleado">
//         <MenuItem onClick={handleClose}>Agregar Empleado</MenuItem>
//         </Link>
//         <Link to= "/components/generarnomina">
//         <MenuItem onClick={handleClose}>Generar Nómina</MenuItem>
//         </Link>
//         <Link to= "/login">
